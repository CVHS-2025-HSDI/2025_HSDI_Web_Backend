...
export function addAdmin(first, last, user, passwd, useremail, class_Requests){
    Admin.creae({firstName: first, lastName: last, username: user, password: passwd, semail:useremail, classRequests: class_Requests})
};
